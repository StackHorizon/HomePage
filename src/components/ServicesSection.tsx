...
const ServiceCard: React.FC<ServiceCardProps> = ({
    ...
    return (
        <Card
            className={`glass border-${color}/30 group overflow-hidden opacity-0 animate-fade-in ${rotateValue} hover:rotate-0 transition-all duration-300`}
            style={{animationDelay}}>
            <div className="p-6 relative">
                <div
                    className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-transparent to-street-purple/10 rounded-bl-3xl -z-10"></div>
                ...
                <div
                    className={`w-14 h-14 rounded-xl bg-${color}/20 flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 relative`}>
                    <div className={`text-${color}`}>{icon}</div>

                    {/* Radial gradient overlay */}
                    <div
                        className={`absolute inset-0 rounded-xl bg-gradient-radial from-${color}/30 to-transparent opacity-60`}></div>
                </div>
    ...
    const services = [
        {
            ...
            title: "Sviluppo Web",
            description: "Siti web e web application con stile e modernità. Progettiamo esperienze uniche.",
            color: "street-purple",
        ...
        },
        {
            ...
            title: "Noi per voi",
            description: "Siamo il tuo team di sviluppo dedicato. Collaboriamo per realizzare le tue idee.",
            color: "street-orange",
        ...
        },
        {
            ...
            description: "Connessioni API e sviluppo backend per potenziare le tue applicazioni. Integriamo il tuo mondo.",
            color: "street-blue"
        },
        {
        ...
        },
        {
            ...
            title: "Progetti per ogni ambiente",
            description: "Che sia il tuo progetto personale o una idea industriale noi la realizzermo per te",
            color: "street-neon"
        }
    ];
    ...
    return (
        <section id="services" className="py-20 relative">
            ...
            <div className="absolute inset-0 -z-10 overflow-hidden">
                <div
                    className="absolute -top-20 -left-20 w-64 h-64 rounded-full bg-street-purple/20 filter blur-3xl"></div>
                <div
                    className="absolute -bottom-20 -right-20 w-80 h-80 rounded-full bg-street-orange/20 filter blur-3xl"></div>
                <div
                    className="absolute top-1/3 right-1/4 w-40 h-40 rounded-full bg-street-neon/10 filter blur-3xl animate-pulse-slow"></div>
                ...
                <div
                    className="absolute bottom-40 left-20 w-32 h-32 border border-dashed border-street-red/20 rounded-full"></div>
            ...
            <div className="container">
                <div className="text-center mb-16 opacity-0 animate-fade-in">
                    ...
                    <h2 className="text-3xl md:text-5xl font-bold mb-6 relative inline-block">
                        ...
                        <span
                            className="absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r from-street-purple via-street-orange to-transparent"></span>
                    </h2>

                    <p className="text-gray-400 md:text-lg max-w-2xl mx-auto relative">
                        Servizi ed esperienza per efficienza pervasa di nuove idee<br/>
                        ...
                        <span
                            className="absolute -left-6 -top-6 text-4xl text-street-purple opacity-20 font-bold">"</span>
                        <span
                            className="absolute -right-6 -bottom-6 text-4xl text-street-purple opacity-20 font-bold">"</span>
                    </p>
                </div>
                ...
                <div className="mt-16 flex justify-center">
                    <div className="glass px-6 py-3 rounded-xl text-sm text-street-neon">
                        <span className="mr-2">✓</span> Prossimamente altri servizi <span
            ...
            <div
                className="absolute bottom-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-street-purple to-transparent"></div>
            <div
                className="absolute bottom-10 left-0 w-full h-px bg-gradient-to-r from-street-orange to-transparent"></div>
        </section>
    );
};
