  ...
  return (
    <section id="contact" className="py-20 relative">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-1/3 left-1/4 w-1/4 h-1/4 bg-street-neon/10 rounded-full filter blur-3xl"></div>
        ...
        <div className="absolute inset-0 opacity-5">
          ...
          <div className="absolute bottom-40 right-20 w-20 h-20 border-2 border-street-purple/30 rounded-full"></div>
      ...
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="opacity-0 animate-fade-in">
              ...
              <p className="text-gray-300 max-w-lg">
                Pronto a portare il tuo brand al <span className="text-street-neon">livello successivo</span>? Scrivici e scopri come possiamo dare <span className="text-street-orange">stile urban</span> alla tua presenza online.
              </p>
            </div>
            
            <div className="grid md:grid-cols-2 gap-6 opacity-0 animate-fade-in" style={{ animationDelay: "0.1s" }}>
              <div className="glass p-6 rounded-xl hover:bg-white/20 transition-colors transform rotate-1 hover:rotate-0 hover:translate-y-[-5px] group relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-street-purple/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div className="relative z-10">
                  <Mail className="h-6 w-6 text-street-purple mb-3" />
                  <h3 className="text-xl font-bold mb-2">Email</h3>
                  <p className="text-street-purple">crew@stackhorizon.it</p>
                </div>
                <div className="absolute bottom-0 left-0 w-full h-1 bg-street-purple transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></div>
              </div>
              
              <div className="glass p-6 rounded-xl hover:bg-white/20 transition-colors transform -rotate-1 hover:rotate-0 hover:translate-y-[-5px] group relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-street-orange/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div className="relative z-10">
                ...
                <div className="absolute bottom-0 left-0 w-full h-1 bg-street-orange transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></div>
              </div>
            </div>
            ...
            <div className="opacity-0 animate-fade-in" style={{ animationDelay: "0.2s" }}>
              ...
              <div className="mt-8 flex space-x-4">
                {["IG", "FB", "TW", "YT"].map((platform) => (
                  <a 
                    key={platform} 
                    href="#" 
                    className="w-10 h-10 rounded-full flex items-center justify-center glass hover:bg-white/20 transition-colors transform hover:scale-110 hover:rotate-3"
                  >
                    {platform}
                  </a>
                ))}
          ...
          <div className="glass p-8 rounded-2xl opacity-0 animate-fade-in transform rotate-1 hover:rotate-0 transition-transform relative overflow-hidden" style={{ animationDelay: "0.3s" }}>
            {/* Decorative elements */}
            <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-bl from-street-purple/10 to-transparent"></div>
            <div className="absolute bottom-0 left-0 w-20 h-20 bg-gradient-to-tr from-street-orange/10 to-transparent"></div>
            ...
            <form className="space-y-6 relative z-10">
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium mb-1 flex items-center gap-1">
                  <Sparkles className="h-3 w-3 text-street-yellow" />
                  La tua Mail
                </label>
                <Input
              ...
              <div>
                <label htmlFor="subject" className="block text-sm font-medium mb-1 flex items-center gap-1">
                  <Sparkles className="h-3 w-3 text-street-yellow" />
              ...
              <Button className="w-full bg-gradient-street hover:bg-street-purple/80 transform hover:translate-y-[-3px] transition-all relative group">
                <span className="relative z-10 flex items-center gap-2">
                  Mandaci il Messaggio
                  <Zap className="h-4 w-4 group-hover:animate-pulse" />
                </span>
                <span className="absolute inset-0 w-full h-full bg-gradient-to-r from-street-purple via-street-orange to-street-purple bg-[length:200%_100%] animate-gradient-x opacity-0 group-hover:opacity-80 transition-opacity"></span>
              </Button>
