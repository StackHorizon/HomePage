  ...
  return (
    <footer className="py-12 border-t border-white/10 relative">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-0 left-1/4 w-64 h-64 rounded-full bg-street-purple/10 filter blur-3xl"></div>
        <div className="absolute bottom-0 right-1/4 w-64 h-64 rounded-full bg-street-orange/10 filter blur-3xl"></div>
      ...
      <div className="container">
        <div className="grid md:grid-cols-4 gap-12">
          <div className="space-y-4">
            <a href="/" className="flex items-center gap-2 group">
              <div className="bg-street-purple rounded-lg p-1.5 transition-all duration-300 group-hover:rotate-12 group-hover:scale-110 relative">
                <Building2 className="h-5 w-5" />
                <span className="absolute -top-1 -right-1 w-1.5 h-1.5 rounded-full bg-street-neon"></span>
              </div>
            ...
            <div className="flex space-x-4 pt-2">
              {["IG", "FB", "TW", "GH"].map((social) => (
                <a 
                  key={social} 
                  href="#" 
                  className="w-8 h-8 rounded-full flex items-center justify-center bg-white/10 hover:bg-white/20 transition-colors text-sm transform hover:scale-110 hover:rotate-6"
                  aria-label={social}
                >
                  {social}
                </a>
            ...
            {/* New badge */}
            <div className="inline-block px-3 py-1 rounded-full bg-street-neon/10 border border-street-neon/20 text-street-neon text-xs flex items-center gap-1">
          ...
          <div>
            ...
            <div className="mt-4 inline-flex items-center">
              <span className="text-xs bg-street-orange/20 text-street-orange px-2 py-0.5 rounded-full flex items-center gap-1">
        ...
        {/* Decorative line */}
        <div className="mt-10 h-px w-full bg-gradient-to-r from-transparent via-street-purple/30 to-transparent"></div>
        
        {/* Credits line */}
        <div className="mt-6 text-center text-xs text-gray-500">
          Designed with <span className="text-street-red">♥</span> in Italia | Made in the <span className="text-street-neon">Digital Streets</span>
        </div>
      </div>
    </footer>
  );
